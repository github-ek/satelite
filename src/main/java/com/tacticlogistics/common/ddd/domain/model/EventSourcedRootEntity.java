...
package com.tacticlogistics.common.ddd.domain.model;
...
public abstract class EventSourcedRootEntity extends AssertionConcern {
    ...
    protected void mutateWhen(DomainEvent aDomainEvent) {
        ...
        try {
            ...
            throw new RuntimeException("Method " + MUTATOR_METHOD_NAME + "(" + eventType.getSimpleName()
                    + ") failed. See cause: " + e.getMessage(), e);
    ...
    private Method cacheMutatorMethodFor(String aKey, Class<? extends EventSourcedRootEntity> aRootType,
        ...
        synchronized (mutatorMethods) {
            try {
                ...
                throw new IllegalArgumentException(
                        "I do not understand " + MUTATOR_METHOD_NAME + "(" + anEventType.getSimpleName() + ") because: "
    ...
    private Method hiddenOrPublicMethod(Class<? extends EventSourcedRootEntity> aRootType,
