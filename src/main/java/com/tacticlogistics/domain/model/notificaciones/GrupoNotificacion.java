...
@Entity
@Table(name = "GruposNotificacion", catalog = "notificaciones")
public class GrupoNotificacion implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "id_grupo_notificacion", nullable = false, unique = true)
	private Integer id;
	...
	public String toString() {
		...
		builder.append("GrupoNotificacion [");
		if (id != null)
