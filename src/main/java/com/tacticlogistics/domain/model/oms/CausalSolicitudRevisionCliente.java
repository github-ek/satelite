...
@Entity
@Table(name = "CausalesSolicitudRevisionCliente", catalog = "oms")
public class CausalSolicitudRevisionCliente implements Serializable {
    private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "id_causal_solicitud_revision_cliente", nullable = false, unique = true)
    private Integer id;
    ...
    protected CausalSolicitudRevisionCliente() {
    ...
    public String toString() {
        ...
        builder.append("CausalSolicitudRevisionCliente [");
        if (id != null) {
