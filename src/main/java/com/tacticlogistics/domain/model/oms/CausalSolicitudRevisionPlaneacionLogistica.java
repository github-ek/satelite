...
@Entity
@Table(name = "CausalesSolicitudRevisionPlaneacionLogistica", catalog = "oms")
public class CausalSolicitudRevisionPlaneacionLogistica implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "id_causal_solicitud_revision_planeacion_logistica", nullable = false, unique = true)
	private Integer id;
	...
	protected CausalSolicitudRevisionPlaneacionLogistica() {
    ...
    public String toString() {
        ...
        builder.append("CausalSolicitudRevisionPlaneacionLogistica [");
        if (id != null) {
