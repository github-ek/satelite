...
@Entity
@Table(name = "TiposTransportadora", catalog = "tms")
public class TipoTransportadora implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "id_tipo_transportadora", nullable = false, unique = true)
	private Integer id;
	...
	public String toString() {
		...
		builder.append("TipoTransportadora [");
		if (id != null)
