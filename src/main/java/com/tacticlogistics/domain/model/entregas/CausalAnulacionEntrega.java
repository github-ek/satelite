...
@Entity
@Table(name = "CausalesAnulacionEntrega", catalog = "ordenes")
public class CausalAnulacionEntrega implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "id_causal_anulacion_entrega", nullable = false, unique = true)
	private Integer id;
	...
	protected CausalAnulacionEntrega() {
	...
	public String toString() {
		...
		builder.append("CausalAnulacionEntrega [");
		if (id != null)
