...
@Entity
@Table(name = "TiposDistribucion", catalog = "crm")
public class TipoDistribucion implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "id_tipo_distribucion", nullable = false, unique = true)
	private Integer id;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TipoDistribucion other = (TipoDistribucion) obj;
		if (codigo == null) {
	...
	public String toString() {
		...
		builder.append("TipoDistribucion [");
		if (id != null)
