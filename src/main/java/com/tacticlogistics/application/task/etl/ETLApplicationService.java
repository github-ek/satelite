...
public class ETLApplicationService {
    ...
    protected void procesarSubdirectorios(final Path raiz, final Path entrada, final Path salida, final Path procesados,
        ...
        procesarArchivos(raiz, entrada, salida.resolve(subdirectorioBackup), procesados.resolve(subdirectorioBackup), errores.resolve(subdirectorioBackup));
...
//        }
        ...
        if (archivos != null && archivos.length > 0) {
            ...
            String codigoComponente = raiz.getParent().getParent().relativize(raiz.getParent())+"."+subdirectorio.toString().replace("\\", ".");
            ...
            try {
                ...
                log.error("NO EXISTE UN COMPONENTE PARA EL COMPONENTE {}, DIRECTORIO {}", codigoComponente, entrada.toString());
            }
        }
    }
